...
class Basic_Sampler(object):
    ...
    def _cpu_sampler_initial(self):
        ...
        from .distribution_sampler_cpu import distribution_sampler_cpu
        ...
        from .model_sampler_cpu import model_sampler_cpu
    ...
    def _gpu_sampler_initial(self):
        ...
        from .distribution_sampler_gpu import distribution_sampler_gpu
        ...
        from .model_sampler_gpu import model_sampler_gpu
