...
parser.add_argument("--load_path", type=str, default='../../save_models/PGDS.npy', help="the path of loading model")

parser.add_argument("--z_dim", type=int, default=100, help="dimensionality of the z latent space")
...
# =========================================== Dataset ===================================================================== #
# define transform for dataset and load orginal dataset
model = PGDS(K=args.z_dim, device=args.device)
