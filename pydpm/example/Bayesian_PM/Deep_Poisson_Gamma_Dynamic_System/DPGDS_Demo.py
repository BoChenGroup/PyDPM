...
parser.add_argument("--load_path", type=str, default='../../save_models/DPGDS.npy', help="the path of loading model")

parser.add_argument("--z_dims", type=list, default=[200, 100, 50], help="number of topics in DPGDS")
...
model = DPGDS(K=args.z_dims, device=args.device)
